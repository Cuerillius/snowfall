...
// @version      2025-12-18
// @description  Winter has come! It now snows on all websites.
// @author       Cuerillius
// @match        *://*/*
// @icon         https://www.google.com/s2/favicons?sz=64&domain=snow.com
// @grant        none
// ==/UserScript==
...
container.style = "position:fixed;top:0;left:0;width:100%;height:100%;z-index:99999;pointer-events:none;";
container.id = "snow";
...
class ShaderProgram {
  ...
  mousemove( e ) {
    let x = e.clientX / this.width * 2 - 1
    let y = e.clientY / this.height * 2 - 1
...
const snow = new ShaderProgram( holder, {
  ...
  fragment: `
    ...
    void main() {
      ...
      // Keep colors separate to work well with gl.ONE_MINUS_SRC_ALPHA
  ...
  onUpdate( delta ) {
    ...
    wind.current += wind.force * ( delta * 0 )
